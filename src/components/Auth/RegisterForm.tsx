...
const RegisterForm: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-accent via-primary to-secondary flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-accent to-primary rounded-2xl mb-6 shadow-lg">
          ...
          <div className="flex items-center justify-center space-x-1 mt-2">
            ...
            <span className="text-sm text-primary font-medium">Professional Chat Experience</span>
            <Sparkles className="w-4 h-4 text-primary" />
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="space-y-2">
            ...
            />
            {errors.name && (
              <p className="text-error text-sm font-medium">{errors.name.message}</p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors.confirmPassword && (
              <p className="text-error text-sm font-medium">{errors.confirmPassword.message}</p>
            )}
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-gradient-to-r from-accent to-primary text-white py-4 px-6 rounded-xl hover:shadow-lg focus:ring-2 focus:ring-primary/20 focus:ring-offset-2 transition-all duration-200 font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center transform hover:scale-[1.02] active:scale-[0.98]"
          >
            {isLoading ? (
              <>
